...
const DiabetesPredictionScreen = () => {
  const [tinhTrangHutThuoc, setTinhTrangHutThuoc] = useState("");
  ...
  const handleGuiThongTin = async () => {
    ...
    try {
      ...
      console.log("Kết quả dự đoán:", response);
      setKetQua(response);
      setShowResult(true);
    } catch (error: any) {
      ...
      try {
        ...
        console.log("Lỗi khi phân tích thông báo lỗi:", parseError);
      }
  ...
  return (
    <View className="flex-1 bg-white p-6">
      {/* Picker & TextInput giữ nguyên */}
      {/* Tình trạng hút thuốc */}
      <View className="mb-4">
        <Text className="text-lg font-bold mb-2">Tình trạng hút thuốc:</Text>
      ...
      >
        <Text className="text-white font-semibold text-lg">Gửi thông tin</Text>
      </TouchableOpacity>
      ...
      <View className="mt-10">
        ...
        <Text className="text-base text-gray-700">
          Xét nghiệm hemoglobin A1c (HbA1c) phản ánh lượng glucose trong máu gắn
          với hemoglobin trong ba tháng qua. Ba tháng là tuổi thọ trung bình của
          một tế bào hồng cầu. Mức glucose trong máu càng cao thì lượng glucose
          gắn vào hemoglobin càng nhiều. Mức HbA1c cao là dấu hiệu của bệnh tiểu
