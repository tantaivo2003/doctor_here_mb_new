...
const MemberMedicineSchedule = ({ navigation, member }: Props) => {
  console.log("MemberMedicineSchedule", member); // Log the member data for debugging
...
export default MemberMedicineSchedule;
