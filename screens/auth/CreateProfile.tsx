      ...
      <>
        ...
        <View className="items-center mb-6">
          <TouchableOpacity onPress={pickImage} className="relative">
            ...
            />
            <View className="absolute bottom-1 right-0 bg-gray-200 p-1 rounded-full">
        ...
        <View className="">
          {/* Nhập họ và tên */}
          <View className="flex-row items-center border border-gray-300 px-2 py-5 rounded-lg mb-6">
          ...
          <TouchableOpacity
            ...
            className="flex-row items-center border border-gray-300 px-2 py-5 rounded-lg mb-6"
          >
        ...
        {/* Nút Lưu */}
        <TouchableOpacity
          className="w-full bg-blue-500 p-3 rounded-full mt-6"
          onPress={handleSave}
        >
